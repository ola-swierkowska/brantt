...
<footer id="colophon" class="footer">
  ...
  <div class="site-info">
    <a class="no-external-link-indicator powered-by-wordpress" href="<?php echo esc_url( __( 'http://wordpress.org/', 'air-light' ) ); ?>">
      ...
      <span>
        <?php printf( esc_html__( 'Copyright %s', 'air-light' ), 'Ola Świerkowska' ); ?>.
      </span>
    </a>
